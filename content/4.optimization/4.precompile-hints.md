...
To learn how to generate hints from your guest program, including FFI helper functions, custom hint handlers, and the deterministic execution requirement, see [Generating Hints](/optimization/generating-hints).
